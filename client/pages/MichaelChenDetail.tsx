...
export function MichaelChenDetail() {
  const claimantData = {
    name: "Michael Chen",
    displayName: "Michael Chen",
    initials: "MC",
    role: "Third Party Claimant",
    totalIncurred: "$15,750.00",
    reserves: "$8,200.00",
    paid: "$7,550.00",
  };
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div>
                ...
                <div className="flex items-center mt-1">
                  ...
                  <p className="text-sm text-gray-600">michael.chen@email.com</p>
                </div>
              </div>
              <div>
                <label className="text-sm font-medium text-gray-900">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 mt-1">***-**-3456</p>
              </div>
              <div>
                <label className="text-sm font-medium text-gray-900">
                  Driver's License
                </label>
                <p className="text-sm text-gray-600 mt-1">MA DL345678901</p>
              </div>
              <div>
                <label className="text-sm font-medium text-gray-900">
                  Employment Status
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 mt-1">Chen & Partners LLP</p>
              </div>
            </div>
          </CardContent>
        </Card>
