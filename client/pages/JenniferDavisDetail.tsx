...
export function JenniferDavisDetail() {
  const claimantData = {
    name: "Jennifer Davis",
    displayName: "Jennifer Davis",
    totalIncurred: "$14,300.00",
    reserves: "$7,100.00",
    paid: "$7,200.00",
  };
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div>
                ...
                <div className="flex items-center mt-1">
                  ...
                  <p className="text-sm text-gray-600">jennifer.davis@email.com</p>
                </div>
              </div>
              <div>
                ...
                <div className="flex items-center mt-1">
                  ...
                  <p className="text-sm text-gray-600">123 Maple Dr, Denver, CO 80201</p>
                </div>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 mt-1">CO DL456789012</p>
              </div>
              <div>
                <label className="text-sm font-medium text-gray-900">Employment Status</label>
                <p className="text-sm text-gray-600 mt-1">Marketing Manager</p>
              </div>
              <div>
                <label className="text-sm font-medium text-gray-900">Attorney</label>
                <p className="text-sm text-gray-600 mt-1">Davis & Associates</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="p-4 bg-gray-50 rounded-lg">
                ...
                <div className="text-xs text-gray-500">57% of available coverage</div>
              </div>
              ...
              <div className="p-4 bg-green-50 rounded-lg">
                ...
                <div className="text-xs text-gray-500">Last payment: Apr 08, 2024</div>
              </div>
            </div>
          </CardContent>
        </Card>
