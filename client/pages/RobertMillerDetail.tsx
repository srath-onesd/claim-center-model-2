            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              <div>
                ...
                <div className="flex items-center mt-1">
                  ...
                  <p className="text-sm text-gray-600">(555) 567-8901</p>
                </div>
              </div>
              <div>
                ...
                <div className="flex items-center mt-1">
                  ...
                  <p className="text-sm text-gray-600">robert.miller@email.com</p>
                </div>
              </div>
              <div>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="p-4 bg-gray-50 rounded-lg">
                ...
                <div className="text-xs text-gray-500">39% of available coverage</div>
              </div>
              ...
              <div className="p-4 bg-green-50 rounded-lg">
                ...
                <div className="text-xs text-gray-500">Last payment: Apr 12, 2024</div>
              </div>
            </div>
          </CardContent>
        </Card>
