              ...
              <CardContent className="p-0">
                <div className="overflow-x-auto">
                  <table className="w-full text-sm">
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                      <tr className="hover:bg-gray-50">
                        <td className="px-4 py-3 whitespace-nowrap">08-15-25</td>
                        <td className="px-4 py-3">Policy Renewal Review - Auto</td>
                      ...
                      <tr className="hover:bg-gray-50">
                        <td className="px-4 py-3 whitespace-nowrap">08-20-25</td>
                        <td className="px-4 py-3">Annual Policy Audit – Rose K</td>
                        <td className="px-4 py-3 whitespace-nowrap">
                      ...
                      <tr className="hover:bg-gray-50">
                        <td className="px-4 py-3 whitespace-nowrap">08-25-25</td>
                        <td className="px-4 py-3">Review & Approve Claim #C1189</td>
                        <td className="px-4 py-3 whitespace-nowrap">
                          <Badge variant="secondary" className="bg-red-100 text-red-800">High</Badge>
                        </td>
                        <td className="px-4 py-3 whitespace-nowrap">
                      ...
                      <tr className="hover:bg-gray-50">
                        <td className="px-4 py-3 whitespace-nowrap">09-01-25</td>
                        <td className="px-4 py-3">Financial Statement Review – Rose K</td>
                        <td className="px-4 py-3 whitespace-nowrap">
