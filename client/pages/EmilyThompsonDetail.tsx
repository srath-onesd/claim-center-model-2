...
export function EmilyThompsonDetail() {
  const claimantData = {
    name: "Emily Thompson",
    displayName: "Emily Thompson",
    totalIncurred: "$16,700.00",
    reserves: "$8,900.00",
    paid: "$7,800.00",
  };
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div>
                ...
                <div className="flex items-center mt-1">
                  ...
                  <p className="text-sm text-gray-600">(555) 678-9012</p>
                </div>
              </div>
              <div>
                ...
                <div className="flex items-center mt-1">
                  ...
                  <p className="text-sm text-gray-600">emily.thompson@email.com</p>
                </div>
              </div>
              <div>
                ...
                <div className="flex items-center mt-1">
                  ...
                  <p className="text-sm text-gray-600">654 Cedar Ave, Portland, OR 97205</p>
                </div>
              </div>
              <div>
                <label className="text-sm font-medium text-gray-900">Social Security</label>
                <p className="text-sm text-gray-600 mt-1">***-**-9012</p>
              </div>
              <div>
                <label className="text-sm font-medium text-gray-900">Driver's License</label>
                <p className="text-sm text-gray-600 mt-1">OR DL890123456</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 mt-1">Thompson Legal Services</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="p-4 bg-gray-50 rounded-lg">
                ...
                <div className="text-xs text-gray-500">67% of available coverage</div>
              </div>
              ...
              <div className="p-4 bg-green-50 rounded-lg">
                ...
                <div className="text-xs text-gray-500">Last payment: Apr 18, 2024</div>
              </div>
            </div>
          </CardContent>
        </Card>
