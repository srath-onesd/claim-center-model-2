            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div>
                ...
                <div className="flex items-center mt-1">
                  ...
                  <p className="text-sm text-gray-600">david.williams@email.com</p>
                </div>
              </div>
              <div>
                ...
                <div className="flex items-center mt-1">
                  ...
                  <p className="text-sm text-gray-600">987 Birch St, Seattle, WA 98101</p>
                </div>
              </div>
              <div>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="p-4 bg-gray-50 rounded-lg">
                ...
                <div className="text-xs text-gray-500">45% of available coverage</div>
              </div>
              ...
              <div className="p-4 bg-green-50 rounded-lg">
                ...
                <div className="text-xs text-gray-500">Last payment: Apr 02, 2024</div>
              </div>
            </div>
          </CardContent>
        </Card>
