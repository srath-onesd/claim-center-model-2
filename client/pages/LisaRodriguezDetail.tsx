...
export function LisaRodriguezDetail() {
  const claimantData = {
    name: "Lisa Rodriguez",
    displayName: "Lisa Rodriguez",
    totalIncurred: "$18,900.00",
    reserves: "$9,500.00",
    paid: "$9,400.00",
  };
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div>
                ...
                <div className="flex items-center mt-1">
                  ...
                  <p className="text-sm text-gray-600">lisa.rodriguez@email.com</p>
                </div>
              </div>
              <div>
                ...
                <div className="flex items-center mt-1">
                  ...
                  <p className="text-sm text-gray-600">654 Cedar Ln, Miami, FL 33101</p>
                </div>
              </div>
              <div>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="p-4 bg-gray-50 rounded-lg">
                ...
                <div className="text-xs text-gray-500">76% of available coverage</div>
              </div>
              ...
              <div className="p-4 bg-green-50 rounded-lg">
                ...
                <div className="text-xs text-gray-500">Last payment: Mar 25, 2024</div>
              </div>
            </div>
          </CardContent>
        </Card>
