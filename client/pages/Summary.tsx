              ...
              <div className="flex-1 ml-4">
                <div className="space-y-1">
                  <div className="flex items-center space-x-2">
                    ...
                    <div className="text-xs text-gray-700" style={{ textAlign: 'right' }}>$2000.00</div>
                  </div>
                  <div className="flex items-center space-x-2">
                    <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                    <span className="text-xs text-gray-700">Paid</span>
                    <span className="text-xs text-gray-700" style={{ textAlign: 'right' }}>$500.00</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <div className="w-2 h-2 bg-amber-500 rounded-full"></div>
                    <span className="text-xs text-gray-700">Recovery</span>
                    <span className="text-xs text-gray-700" style={{ textAlign: 'right' }}>$0.00</span>
                  </div>
                </div>
              </div>
            </div>
