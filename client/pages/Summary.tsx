            ...
            <Card>
              <CardHeader className="cursor-pointer" onClick={() => toggleClaimantCollapse('amy-applegate')}>
                <CardTitle className="text-lg font-semibold flex items-center justify-between">
                  ...
                  {collapsedClaimants['amy-applegate'] ? <ChevronRight className="h-5 w-5" /> : <ChevronDown className="h-5 w-5" />}
                </CardTitle>
              </CardHeader>
            ...
            <Card>
              <CardHeader className="cursor-pointer" onClick={() => toggleClaimantCollapse('bob-pay')}>
                <CardTitle className="text-lg font-semibold flex items-center justify-between">
                  ...
                  {collapsedClaimants['bob-pay'] ? <ChevronRight className="h-5 w-5" /> : <ChevronDown className="h-5 w-5" />}
                </CardTitle>
              </CardHeader>
